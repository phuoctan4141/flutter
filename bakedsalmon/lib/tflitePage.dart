// ignore_for_file: unused_field, prefer_final_fields, non_constant_identifier_names, no_leading_underscores_for_local_identifiers
...
class _TfLitePageState extends State<TfLitePage> {
  ...
  late double _imageHeight = 0;
  late double _imageWidth = 0;
  ...
  Widget build(BuildContext context) {
    ...
    if (_model == deeplab && _recognitions != null) {
      List<int> _ints_recognitions =
          _recognitions.map((e) => e as int).toList();
      Image _img = Image.memory(Uint8List.fromList(_ints_recognitions));
